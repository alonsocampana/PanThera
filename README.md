Code for the publication "PanThera: Predicting the effect of Combination Therapy using Deep Neural Networks", accepted for publication in Briefings in Bioinformatics.
